...
describe('ConversationManager', () => {
  ...
  beforeEach(() => {
    ...
    conversationManager = new ConversationManager(mockDb as any, '/test/project/path');
  });
  ...
  describe('getConversationContext', () => {
    it('should throw an error when no conversation exists', async () => {
      ...
      await expect(conversationManager.getConversationContext()).rejects.toThrow(
  ...
  describe('createConversationContext', () => {
    it('should create a new conversation when none exists', async () => {
      ...
      const result = await conversationManager.createConversationContext('custom');
    ...
    it('should return existing conversation when one already exists', async () => {
      ...
      const result = await conversationManager.createConversationContext('agile');
